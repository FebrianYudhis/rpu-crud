...
<head>
    ...
    <!-- Font Awesome -->
    <link rel="stylesheet" href="http://localhost/crud/plugins/fontawesome-free/css/all.min.css">
    <!-- Ionicons -->
    <link rel="stylesheet" href="https://code.ionicframework.com/ionicons/2.0.1/css/ionicons.min.css">
    <!-- Theme style -->
    <link rel="stylesheet" href="http://localhost/crud/dist/css/adminlte.min.css">
...
<body class="hold-transition sidebar-mini layout-fixed">
    ...
    <div class="wrapper">
        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                        ...
                        <a href="http://localhost/crud/pages/tampil/siswa.php" class="dropdown-item">
                            <i class="fas fa-fw fa-child mr-2"></i> Data Siswa
                        </a>
                        <div class="dropdown-divider"></div>
                        <a href="http://localhost/crud/pages/tampil/nilai.php" class="dropdown-item">
                            <i class="fas fa-fw fa-list-ol mr-2"></i> Data Nilai
                        </a>
                        <div class="dropdown-divider"></div>
                        <a href="http://localhost/crud/pages/tampil/guru.php" class="dropdown-item">
                            <i class="fas fa-fw fa-chalkboard-teacher mr-2"></i> Data Guru
                        </a>
                        <div class="dropdown-divider"></div>
                        <a href="http://localhost/crud/pages/tampil/mapel.php" class="dropdown-item">
                            <i class="fas fa-fw fa-book mr-2"></i> Data Mapel
                        </a>
                        <div class="dropdown-divider"></div>
                        <a href="http://localhost/crud/pages/tampil/jurusan.php" class="dropdown-item">
            ...
            <ul class="navbar-nav ml-auto">
                <a type="button" class="btn btn-warning" href="<?= $data['base']; ?>">Kembali</a>
            </ul>
        </nav>
        <!-- /.navbar -->
